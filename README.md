...
Below is a forest plot for the dataset _greentea_ (included with this R package) which includes 14 studies registered with  [clinicaltrials.gov](clinicaltrials.gov). Of these, 11 are denoted as 'published' and the other 3 are denoted as 'unpublished' (for the purposes of demonstration). All 3 'unpublished' studies were assigned ‘negative’ outcomes. 
