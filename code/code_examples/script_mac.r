...
setwd("/Users/JohnDoe/Desktop/workdir") ## To change the working directory on a Mac computer. An example. 
...
setwd("/Users/JohnDoe/Desktop/workdir/data") ## To change to the directory with the CSV data file. An example.
